...
namespace Asp.Net_end_project.Areas.AdminArea.Controllers
{
    ...
    public class SingleBannerController : Controller
    {
        ...
        {
            SingleBanner banner = await _context.SingleBanners.Where(m => !m.IsDeleted).FirstOrDefaultAsync();
        ...
        public async Task<IActionResult> Edit(int id, SingleBanner banner)
        {
            try
            {
                ...
                string dbPath = Helpers.GetFilePath(_env.WebRootPath, "assets/img/banner", dbBanner.Image);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            string path = Helpers.GetFilePath(_env.WebRootPath, "assets/img/banner", banner.Image);
        ...
        public async Task<SingleBanner> GetByIdAsync(int id)
        {
