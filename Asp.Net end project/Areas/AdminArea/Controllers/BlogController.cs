...
namespace Asp.Net_end_project.Areas.AdminArea.Controllers
{
    ...
    public class BlogController : Controller
    {
        ...
        public async Task<IActionResult> Create(Blog blog)
        {
            ...
            string path = Asp.Net_end_project.Helper.Helpers.GetFilePath(_env.WebRootPath, "assets/img/blog", fileName);
        ...
        public async Task<IActionResult> Update(int id, Blog blog)
        {
            try
            {
                ...
                string dbPath = Asp.Net_end_project.Helper.Helpers.GetFilePath(_env.WebRootPath, "img", blog.Image);

                Asp.Net_end_project.Helper.Helpers.DeleteFile(dbPath);
                return RedirectToAction(nameof(Index));
